...
void CObjectsShader::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	for (int j = 0; j < m_nObjects; j++)
	{
		...
		XMStoreFloat4x4(&pbMappedcbGameObject->m_pxmf4x4TextureTransforms[0], XMMatrixTranspose(XMLoadFloat4x4(&m_ppObjects[j]->m_pxmf4x4TextureTransforms[0])));
		XMStoreFloat4x4(&pbMappedcbGameObject->m_pxmf4x4TextureTransforms[1], XMMatrixTranspose(XMLoadFloat4x4(&m_ppObjects[j]->m_pxmf4x4TextureTransforms[1])));
	}
}
...
D3D12_SHADER_BYTECODE CFlowingLavaShader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTextureTransform", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CFlowingLavaShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
#ifdef _WITH_TEXTURE_TRANSFORM
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureTransform", "ps_5_1", ppd3dShaderBlob));
#endif
#ifdef _WITH_TEXTURE_DISTORTION_TRANSFORM
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureTransformDistortion", "ps_5_1", ppd3dShaderBlob));
#endif
#ifdef _WITH_TEXTURE_DISTORTION_TRANSPARENT_TRANSFORM
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureTransformDistortionTransparent", "ps_5_1", ppd3dShaderBlob));
#endif
}
