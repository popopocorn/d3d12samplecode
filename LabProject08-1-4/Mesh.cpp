...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
CHeightMapGridMesh::CHeightMapGridMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, int xStart, int zStart, int nWidth, int nLength, XMFLOAT3 xmf3Scale, XMFLOAT4 xmf4Color, void* pContext) : CGridMesh(pd3dDevice, pd3dCommandList)
{
	...
	for (int i = 0, z = zStart; z < (zStart + nLength); z++)
	{
		for (int x = xStart; x < (xStart + nWidth); x++, i++)
		{
			pVertices[i].m_xmf3Position.y = OnGetHeight(x, z, pHeightMapImage);
			pVertices[i].m_xmf4Diffuse = OnGetColor(x, z, pHeightMapImage);
		}
	}
...
float CHeightMapGridMesh::OnGetHeight(int x, int z, CHeightMapImage* pHeightMapImage)
{
	float fHeight = 0.0f;
	if (pHeightMapImage)
	{
...
XMFLOAT4 CHeightMapGridMesh::OnGetColor(int x, int z, CHeightMapImage* pHeightMapImage)
{
