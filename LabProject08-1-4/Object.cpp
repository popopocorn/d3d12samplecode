...
CGameObject::CGameObject(int nMeshes)
{
	...
	m_pxmf4x4TextureTransforms[0] = m_pxmf4x4TextureTransforms[1] = Matrix4x4::Identity();
...
void CGameObject::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	XMStoreFloat4x4(&m_pcbMappedGameObject->m_pxmf4x4TextureTransforms[0], XMMatrixTranspose(XMLoadFloat4x4(&m_pxmf4x4TextureTransforms[0])));
	XMStoreFloat4x4(&m_pcbMappedGameObject->m_pxmf4x4TextureTransforms[1], XMMatrixTranspose(XMLoadFloat4x4(&m_pxmf4x4TextureTransforms[1])));
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CFlowingLava::CFlowingLava(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, int nWidth, int nLength) : CGameObject(1)
{
	CreateShaderVariables(pd3dDevice, pd3dCommandList);

	CTexture* pTexture = new CTexture(3, RESOURCE_TEXTURE2D, 0, 1);
	pTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Image/lava2.dds", RESOURCE_TEXTURE2D, 0);
#ifdef _WITH_TEXTURE_DISTORTION_TRANSPARENT_TRANSFORM
	pTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Image/lava1_transparent.dds", RESOURCE_TEXTURE2D, 1);
#else
	pTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Image/lava1.dds", RESOURCE_TEXTURE2D, 1);
#endif
	pTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Image/lava3.dds", RESOURCE_TEXTURE2D, 2);
	...
	pFlowingLavaShader->CreateShader(pd3dDevice, pd3dGraphicsRootSignature);
