...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 1 + 1 + 1 + 10, 1 + 3 + 3 + 10); //Player(1), Skybox(1)
...
/*
	...
	m_pFlowingLava = new CFlowingLava(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 257 * 4, 257);
	m_pFlowingLava->SetPosition(0.0f, m_pTerrain->GetHeight(0.0f, m_pTerrain->GetLength() * 0.25f) * 0.75f, m_pTerrain->GetLength() * 0.25f);
*/
	m_pFlowingLava = new CFlowingLava(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 257 * 4, 257);
	m_pFlowingLava->SetPosition(0.0f, 0.0f, 0.0f);
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[0].BaseShaderRegister = 3; //GameObject
	...
	pd3dDescriptorRanges[2].BaseShaderRegister = 1; //t1: gtxtTerrainBaseTexture, gtxtTerrainDetailTexture
	pd3dDescriptorRanges[2].RegisterSpace = 0;
	pd3dDescriptorRanges[2].OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;

	pd3dDescriptorRanges[3].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[3].NumDescriptors = 3;
	pd3dDescriptorRanges[3].BaseShaderRegister = 3; //t3: gtxtTextures[3]
	...
	pd3dRootParameters[0].Descriptor.ShaderRegister = 2; //Player
	...
	pd3dRootParameters[6].Constants.ShaderRegister = 0; 
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	if (m_pFlowingLava) m_pFlowingLava->Render(pd3dCommandList, pCamera);
