...
//*
	...
	float frequency = 0.01275f;
	input.position.y = sin(input.position.x * frequency) + sin(input.position.z * frequency);
	float t = 0.01f * (-gfCurrentTime * 2.60f);
	input.position.y += sin(input.position.x * frequency * 2.1f + t) * 4.5f + sin(input.position.z * frequency * 2.1f + t) * 4.5f;
	input.position.y += sin(input.position.z * frequency * 1.72f + t * 1.121f) * 4.0f;
//	input.position.y += sin(input.position.x * frequency * 1.72f + t * 1.121f) * 4.0f + sin(input.position.z * frequency * 1.72f + t * 1.121f) * 4.0f;
	input.position.y += sin(input.position.x * frequency * 2.221f + t * 0.437f) * 5.0f + sin(input.position.z * frequency * 2.221f + t * 0.437f) * 5.0f;
//	input.position.y += sin(input.position.x * frequency * 3.1122f + t * 4.269f) * 2.5f + sin(input.position.z * frequency * 3.1122f + t * 4.269f) * 2.5f;
	input.position.y += sin(input.position.z * frequency * 3.1122f + t * 4.269f) * 2.5f;
	input.position.y *= amplitude * 1.56f;
//*/
	input.position.y += 2.0f * (sin(gfCurrentTime * 0.25f + input.position.x * 0.01f) * 45.0f + cos(gfCurrentTime * 0.25f + input.position.z * 0.01f) * 35.0f);
